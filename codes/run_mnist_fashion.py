...
test_accuraciesH2 = []
for i in range(0, 20):
    x_train, xq_train, y_train, x_val, xq_val, y_val, x_test, xq_test, y_test = classical_part.load_mnist_fashion(3600, 1200, 1200)
...
utilities.save_history_train('./exps_mnist_fashion', 'h1', historiesH1)
np.savetxt('exps_mnist_fashion/h1test.txt', test_accuraciesH1)
utilities.save_history_train('./exps_mnist_fashion', 'h2', historiesH2)
np.savetxt('exps_mnist_fashion/h2test.txt', test_accuraciesH2)
utilities.save_history_train('./exps_mnist_fashion', 'h3', historiesH3)
np.savetxt('exps_mnist_fashion/h3test.txt', test_accuraciesH3)
