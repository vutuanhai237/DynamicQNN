...
for i in range(0, 20):
      print('Iteration', i)
      x_train, y_train, x_val, y_val, x_test, y_test = classical_part.load_mnist(1200, 400, 400)
...
utilities.save_history_train('./exps_mnist/h1_50filter', 'h1', historiesH1)
np.savetxt('exps_mnist/h1_50filter/h1test.txt', test_accuraciesH1)
