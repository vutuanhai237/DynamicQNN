...
for i in range(0, 20):
      ...
      x_train, xq_train, y_train, x_val, xq_val, y_val, x_test, xq_test, y_test = classical_part.load_mnist(1200, 300, 300, entangled_circuit.quanvolutional, True)
...
utilities.save_history_train('./exps_mnist/h2_4x4filter_quanv', 'h2', historiesH2)
np.savetxt('exps_mnist/h2_4x4filter_quanv/h2test.txt', test_accuraciesH2)
