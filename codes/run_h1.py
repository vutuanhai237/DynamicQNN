...
utilities.save_history_train('./mnist/h1_' + str(constant.conv_num_filter) + 'filter' + str(
    constant.conv_size_filter) + 'x' + str(constant.conv_size_filter), 'h1', historiesH1)
np.savetxt('mnist/h1_' + str(constant.conv_num_filter) + 'filter' + str(constant.conv_size_filter) + 'x' + str(constant.conv_size_filter) + '/h1test.txt', test_accuraciesH1)
np.savetxt('mnist/h1_' + str(constant.conv_num_filter) + 'filter' + str(constant.conv_size_filter) + 'x' + str(constant.conv_size_filter) + '/time.txt', [(end - start)])
